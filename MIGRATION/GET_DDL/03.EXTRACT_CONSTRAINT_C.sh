#!/bin/bash
# ============================================================
# 03.EXTRACT_CONSTRAINT_C.sh
# Extract CHECK CONSTRAINT (type 'C') DDL for the tables in
# DBADM.MIG_TAB_LIST_{OWNER}.
#   Pass 1 : generate GET_DDL SELECT statements (get_ddl file)
#   Pass 2 : run them and spool the actual DDL
# Usage: 03.EXTRACT_CONSTRAINT_C.sh <OWNER>
# ============================================================

if [[ -z "$1" ]] ; then
  echo "Usage: 03.EXTRACT_CONSTRAINT_C.sh <OWNER>"
